            ...
            <div className="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
              ...
              <div className="col-lg-8 align-self-baseline">
                <p className="text-white-75 mb-5">
                  Founded in 2008, Thai Vinyl Compounds (TVC) is a growing and
                  talented supplier of PVC compounds. We offer a full line of
                  PVC compounds ranging from soft to rigid PVC. We are committed
                  to supplying the highest quality products and services to our
                  customers, providing a safe and healthy workplace for our
                  employees and contributing to the quality of life in the
                  communities where we operate. This commitment is made possible
                  through our dedicated people, consistent products, continued
                  and ongoing investments in new product development, quality
                  control systems and safe, modern and energy-efficient
